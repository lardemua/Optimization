function [cost] = costFunctionCamara(x, intrinsics, worldPoints, s, N, K, vplot, cameraParams)
%% Cost Function
...
for k=1:K
    ...
    [s{k}.xpix, s{k}.ypix] = points2image(dxyz, rod, intrinsics, worldPoints, cameraParams);
